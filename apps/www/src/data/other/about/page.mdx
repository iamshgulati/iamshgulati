...
import { CeritificationBadgesGrid } from "./certification-badges-grid";

## Summary

As an experienced Software Engineer, I have designed and developed scalable, reliable, and secure enterprise applications using cloud-native technologies and best practices. I have approximately 7 years of exceptional software engineering experience at industry-leading U.S. and Canadian professional services firms, where I delivered multiple high-impact projects for various industry leading clients in technology.

I hold a Master's degree in Computer Science and Engineering and two AWS certifications in cloud architecture design, setup, and management. My core competencies include decoupled backend design and development using Java, Spring Boot, and Microservices. I also have experience in optimizing application performance, security, and reliability using various tools and frameworks. I am passionate about learning new technologies and solving complex problems with innovative solutions.
...
Currently on an education break to pursue education in Cloud and Security domains.
Completed a few AWS certifications and built some full-stack applications using
cutting edge web technologies. You are already looking at one of them.
...
<Flex justify="between">
  {/* <em>Saskatoon, SK, Canada</em> */}
  {/* <em>Jan 2023 - Dec 2023</em> */}
</Flex>

- Completed _Cloud Computing & Blockchain_ postgraduate certificate program from Saskatchewan Polytechnic with great distinction.
