...
description: Preview of typography on this website.
---
...
This component is based on the `span` element and supports _common margin props_.
...
```jsx live=true showLineNumbers title="Text" caption="Text as a another html element"
...
```jsx live=true scroll=true showLineNumbers
...
```jsx live=true showLineNumbers {5-7}
...
```jsx live="true" showLineNumbers
<Flex direction="column">
  <Text highContrast color="indigo">
    The quick brown fox jumps over the lazy dog.
  </Text>
  <Text highContrast color="cyan">
    The quick brown fox jumps over the lazy dog.
  </Text>
  <Text highContrast color="orange">
    The quick brown fox jumps over the lazy dog.
  </Text>
  <Text highContrast color="crimson">
    The quick brown fox jumps over the lazy dog.
  </Text>
</Flex>
```
