...
import { allLearnings } from "~/lib/mdx-frontmatter";

const TITLE = "Today";
const DESCRIPTION = "Short notes on new things I learned today.";
...
const AllLearningsSection = (): React.JSX.Element => {
  return (
    <Flex direction="column" gap="6">
      {allLearnings.map((learning) => (
        <Box key={learning.slug}>
          <Heading mb="2">{learning.title}</Heading>
