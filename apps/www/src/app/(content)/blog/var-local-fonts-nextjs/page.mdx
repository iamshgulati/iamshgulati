...
From here, the documentation is pretty clear. You just add `sansFont.variable` to `className` on `body` tag, prepend `var(--font-sans)` to your `font-family` and you are set.
