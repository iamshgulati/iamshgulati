...
type FloatingFloatingBackButtonProps = React.ComponentPropsWithoutRef<typeof IconButton> & {
...
export const FloatingBackButton = ({
	...
	return (
		<Box data-scrolled-state={`${scrolled}`} className={styles.FloatingBackButtonContainer}>
			<IconButton
