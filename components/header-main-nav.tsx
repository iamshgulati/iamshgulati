...
export const HeaderMainNav = ({ pages }: HeaderMainNavProps): React.JSX.Element => {
...
type HeaderMainNavLinkProps = React.PropsWithChildren<React.ComponentProps<"a">> & {
	active?: boolean;
};
...
const HeaderMainNavLink = ({
	...
	<NextLink href={href ? href : "#"} passHref legacyBehavior>
		<a data-state={active ? "active" : "inactive"} className={styles.HeaderMainNavLink} {...props}>
