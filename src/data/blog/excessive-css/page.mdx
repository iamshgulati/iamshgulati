export const metadata = {
  ...
  description:
    "Is there a better way to reduce the css bundle size when using component libraries?",
  image:
    "https://unsplash.com/photos/NYcUkFJuxg0/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8MTB8fGNzc3xlbnwwfHx8fDE3MTkyODcyODR8MA&force=true&w=640",
...
> Doing this cut down the overall css bundle by half. And <Link href="https://pagespeed.web.dev">Pagespeed</Link> also stopped complaining about unused css.
